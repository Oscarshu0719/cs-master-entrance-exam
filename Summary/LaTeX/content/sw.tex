...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Convert to undirected graph and solved by Hamiltonian path problem: 
            ...
            \end{figure}
    \end{itemize}
    \item Fibonacci search: \lstinputlisting[caption={Fibonacci search.}, captionpos=b, language=Python]{code/fib_search.py}
    ...
    \item (leetcode-84) Largest Rectangle in Histogram: \lstinputlisting[caption={Largest Rectangle in Histogram.}, captionpos=b, language=Python]{code/largest_rect.py}
    \item \begin{itemize}
