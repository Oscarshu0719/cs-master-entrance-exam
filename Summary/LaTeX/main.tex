...
\includepdf[pages=-]{summary/math/math.pdf}
\includepdf[pages=-]{summary/la/la.pdf}
\includepdf[pages=-]{summary/dm/dm.pdf}
\include{content/sw}
\includepdf[pages=-]{summary/sw/sw.pdf}
\includepdf[pages=-]{summary/algo/algo.pdf}
\include{content/hw}
\includepdf[pages=-]{summary/hw/hw.pdf}
